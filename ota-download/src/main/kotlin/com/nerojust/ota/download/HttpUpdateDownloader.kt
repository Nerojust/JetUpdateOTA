...
class HttpUpdateDownloader(private val httpClient: OkHttpClient) : UpdateDownloader {
    ...
    override fun download(manifest: UpdateManifest, targetDir: File): Flow<DownloadProgress> = flow {
        ...
        .catch { e -> emit(DownloadProgress.Failed(OTAException.NetworkError(e as? IOException ?: IOException(e)))) }
